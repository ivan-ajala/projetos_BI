...
function App() {
  ...
  <div className="header-period">
    {formatMonthYear(revenue.first_month)} — {formatMonthYear(revenue.last_month)}
  </div>
</header>
  ...
  <div className="kpi-grid forecast-grid">
    ...
    <div className="kpi-card forecast-card">
      ...
      <p className="model-value">
        {forecast.model_used === "moving_average_3m"
  ...
  <div className="forecast-methodology">
    ...
    <p>
      A projeção é uma estimativa direcional baseada no comportamento histórico
      da receita. O horizonte projetado cobre{" "}
      <strong>
    ...
    <p>
      ...
      corresponde ao RMSE observado no conjunto de teste. Essa faixa é uma
      aproximação prática e não representa um intervalo de confiança estatístico
      formal.
    </p>
  </div>
</section>
  ...
  <div className="context-grid">
    ...
    <article className="context-card">
      ...
      <p>
        ...
        reduzindo o efeito da cobertura parcial e da lacuna observada em 2016.
      </p>
    </article>
    ...
    <article className="context-card context-card-highlight">
      ...
      <p>
        ...
        aproximada e não representa um intervalo de confiança estatístico formal.
      </p>
    </article>
  </div>
</section>
...
function formatModelName(modelName) {
  const modelNames = {
    moving_average_3m: 'Média móvel — 3 meses',
    naive: 'Ingênuo',
